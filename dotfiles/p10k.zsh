# Generated by Powerlevel10k configuration wizard on 2025-11-24 at 07:07 CST.
...
# ===== Synthwave segment colors (left prompt) =====

# Base prompt bg/fg (behind segments)
typeset -g POWERLEVEL9K_BACKGROUND='#1e1f29'
typeset -g POWERLEVEL9K_FOREGROUND='#9aecff'

# --- OS icon segment (left-most block) ---
# Bright magenta block, dark text/icon
typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND='#ff79c6'
typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND='#1e1f29'

# --- Directory segment ---
# Purple block, light text
typeset -g POWERLEVEL9K_DIR_BACKGROUND='#3b2f5c'                # deep violet
typeset -g POWERLEVEL9K_DIR_HOME_BACKGROUND='#3b2f5c'
typeset -g POWERLEVEL9K_DIR_HOME_SUBFOLDER_BACKGROUND='#3b2f5c'
typeset -g POWERLEVEL9K_DIR_ETC_BACKGROUND='#3b2f5c'

# Main path text: light, high contrast, no cyan
typeset -g POWERLEVEL9K_DIR_FOREGROUND='#f8f8ff'                # near-white
typeset -g POWERLEVEL9K_DIR_HOME_FOREGROUND='#f8f8ff'
typeset -g POWERLEVEL9K_DIR_HOME_SUBFOLDER_FOREGROUND='#f8f8ff'
typeset -g POWERLEVEL9K_DIR_ETC_FOREGROUND='#f8f8ff'

# Accents: warm gold, still no cyan
typeset -g POWERLEVEL9K_SHORTENED_DIR_FOREGROUND='#ffd88a'
typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND='#ffd88a'


# --- Git/VCS segment ---
# Soft neon yellow block instead of orange, dark text
typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND='#E7F73B'
typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND='#1e1f29'

typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND='#7E8906'
typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND='#1e1f29'

typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND='#ADF7B6'
typeset -g POWERLEVEL9K_VCS_MODIFIED_FOREGROUND='#1e1f29'

typeset -g POWERLEVEL9K_VCS_STAGED_BACKGROUND='#33EB48'
typeset -g POWERLEVEL9K_VCS_STAGED_FOREGROUND='#1e1f29'
typeset -g POWERLEVEL9K_TIME_BACKGROUND='#c8a2ff'
